...
function searchBill () {
    ...
    $.ajax( {
        url:'http://localhost:8080/Online_Account_Book_war_exploded/wl/searchBills',
        type:'post',
        dataType: 'json',
        data: {
...
function onlySeeIn () {
    ...
    if (!isSearch) {
        $.ajax({
            url:'http://localhost:8080/Online_Account_Book_war_exploded/wl/onlySeeIn1',
            type:'post',
            dataType:'json',
            data :{
                sort_type:sort_type
...
function onlySeeOut () {
    ...
    if (!isSearch) {
        $.ajax({
            url:'http://localhost:8080/Online_Account_Book_war_exploded/wl/onlySeeOut1',
            type:'post',
            dataType:'json',
            data :{
                sort_type:sort_type
...
function seeAll () {
    ...
    $.ajax({
        url:'http://localhost:8080/Online_Account_Book_war_exploded/wl/getBills',
        type:'post',
        dataType:'json',
        success: function (resp) {
            console.log(resp);
...
function saveToServer (action,bill,callback) {
    ...
    $.ajax ({
        url: "http://localhost:8080/Online_Account_Book_war_exploded/wl/addOrDeleteBill",
        type:'post',
        dataType: "json",
        data: {
            action:action,
...
function edit(element) {
    ...
    jQuery.ajax({
        url:"http://localhost:8080/Online_Account_Book_war_exploded/wl/getBill",
        type: 'post',
        data: {id: elemid},
        dataType: "json",
        beforeSend: function () {
...
function updateOut() {
    jQuery.ajax({
        url: "http://localhost:8080/Online_Account_Book_war_exploded/wl/modifyBill",          // 对应 Code-10.1 第 17 行, 注意多了 "/wl" 前缀
...
function sort() {
    ...
    jQuery.ajax({
        url: "http://localhost:8080/Online_Account_Book_war_exploded/sort",          // 对应 Code-10.1 第 17 行, 注意多了 "/wl" 前缀
        type: 'post', // 声明以 Post 方式发送请求
        data: {
            sort_type:sort_type,
            oldBills:JSON.stringify(s)
